...
*you should have seen no password prompt*: If you did, something went wrong in Step
2.  To diagnose:

* Check to make sure your user is apart of the admin group
* make sure no other config lines conflict.

*If you saw a configuration error*, follow the instructions shown. If it was a
ruby parse error, you probably forgot to close a parenthesis pair, forgot a
command, put in an extra command, etc.
...
This should've prompted you for a password. If it doesn't, your sudoers change
...
message at you if one of the commands errored out. Please report any bugs
"here":http://github.com/timcharper/caprese/issues.
